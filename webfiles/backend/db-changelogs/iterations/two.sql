...
-- changeset austin:5
-- Add user for accessing db
BEGIN;

CREATE ROLE schemastore WITH LOGIN PASSWORD 'password';
GRANT CONNECT ON DATABASE schemastoredb TO schemastore;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO schemastore;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO schemastore;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON TABLES TO schemastore;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON SEQUENCES TO schemastore;
